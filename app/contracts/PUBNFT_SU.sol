...
contract PUBNFT_SU is Ownable, Pausable,IERC721Receiver{

    PUNFT_SU public nftAddress;
    ...
    //_nft_Address of mint token from this token
    constructor(address _nftAddress){
        nftAddress = PUNFT_SU(_nftAddress);
    }
